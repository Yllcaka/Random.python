...
# d = 3
#
# def arithmeticRecursion2(a1, n, d):
#     if n <= 1:
#         return a1
#
#     return arithmeticRecursion2(a1, n-1, d) + d
#
# # print('Numri i kthyer eshte: ' + str(arithmeticRecursion2(a1, n, d)))
#
# # a1 = 1
# # r = 2
# # n = 4
...
print(arithmeticRecursion(56))
print(arithmeticRecursion2(2,3,4))